...
\begin{PauseHighLight}
  ...
  \item Increasingly applications focus on very large (sparse) graphs
...
\begin{PauseHighLight}
  ...
  \item To traverse a graph we start at a (arbitrary) \textit{root}
    vertex\pauseh
  \item We then follow edges to create a tree\pauseh
\begin{center}
...
\pause
\begin{center}
  \includegraphics[width=0.9\linewidth]{graphBfs-0}\mypl{1}
...
\begin{PauseHighLight}
  ...
  \item In your graduation ceremony there is the VC, Provost, Dean, HOS,
    Professors, etc.\pause---in what order should they precess?\pauseb 
  \item If the graphs were not acyclic it would be impossible to process them!\pauseb
  \end{itemize}
\end{PauseHighLight}
...
\begin{PauseHighLight}
  ...
  \item Topological sort is not a traditional ``sort''\pause---it is a sort for
    partially ordered sets\pauseb---, but it is a useful algorithm
    for some applications\pauseb
  \end{itemize}
\end{PauseHighLight}
...
\end{itemize}
\begin{center}
  \includegraphics[width=0.9\linewidth]{topologicalSort-0}\mypl{2}
...
\pb\pause
  \includegraphics[height=12cm]{directedDfs-0}\mypl{1}
  \llap{\includegraphics[height=12cm]{directedDfs-1}\pause}
\end{slide}
...
\item Euler Cycles \pauseh \hfil
  \begin{minipage}{0.3\linewidth}
    \begin{center}
      \includegraphics[width=0.9\linewidth]{eulerCycle-0}\mypl{2}
      \multido{\ia=1+1,\ib=3+1}{11}%
      {\llap{\includegraphics[width=0.9\linewidth]{eulerCycle-\ia}\mypl{\ib}}}
      \llap{\includegraphics[width=0.9\linewidth]{eulerCycle-12}\pause}
    \end{center}
  \end{minipage}
