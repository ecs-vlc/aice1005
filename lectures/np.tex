...
\vspace{-2cm}
\begin{center}
  \includegraphics[height=10cm]{dp}
\end{center}
...
\begin{PauseHighLight}
  ...
  \item We have seen a large number of decision problems and
    ...
    space\pause: binary strings\pauseb, paths through graphs, etc.\pauseb 
...
\begin{center}
  \includegraphics[height=14cm]{dp}
\end{center}
