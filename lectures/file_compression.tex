...
\begin{center}
  \includegraphics[width=\linewidth]{huffman_normal}
\end{center}
\end{slide}
...
\begin{center}
  \multipdf[width=0.9\linewidth]{huffman_normal2}\pause
\end{center}
\end{slide}
...
\begin{slide}
\section[-2]{Signals and Energies}
...
\begin{PauseHighLight}
  ...
  \item Many other wavelets capture other properties (e.g. Coiflets
    ...
    points)\pause
  \item Efficiency of wavelets depend on how well they capture underlying
