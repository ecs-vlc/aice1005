...
\begin{PauseHighLight}
  \begin{itemize}
  \item We saw earlier Dijkstra's algorithm for find the minimum distance
  ...
  \item However, we should perhaps more rightly identify it as using a
    ...
    of the partial solution to reach a node\pause
...
\begin{slide}
\section{Going from Node 0 to Node 9}
...
\item If we know the optimal sub-tour through all sets of cities of
  ...
  $k+1$\pauseh
  \begin{center}
    \multipdf[height=8cm]{tsp_dp}\pause  
  \end{center}
\end{itemize}
