...
\lstloadlanguages{Java,pseudo,C++}
\lstset{
...
\lstnewenvironment{cpp}[1][]{\lstset{escapechar=\$,#1}}{}
...
\MyLogo{\pauselevel{=1}\Acrobatmenu{GoBack}{%
  \color{TextColor}{AICE1005}} \hspace{7.2cm}
  % Clicking on the name steps one slide back.
  \toplink{firstoutline}{\color{red}{Algorithms and Analysis}}%
